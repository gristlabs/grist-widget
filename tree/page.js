...
let mode = 'multi';
let mapSource = 'https://api.maptiler.com/maps/02c3290e-4c70-4f5f-8701-51554ec4cfb2/style.json?key=TbsQ5qLxJHC20Jv4Th7E';
let mapCopyright = '© MapTiler, © OpenStreetMap contributors';
...
const maptilerAccessToken = 'TbsQ5qLxJHC20Jv4Th7E';
...
function initMap() {
  ...
  map = new maplibregl.Map({
    container: 'map',
    style: mapSource,
    center: [-122.727, 44.465], // Initial center point (longitude, latitude)
